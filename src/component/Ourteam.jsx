...
const OurTeam = () => {
  return (
    <section className="relative w-full min-h-screen overflow-hidden">
      ...
      {/* Optional overlay */}
      <div className="absolute top-0 left-0 w-full h-full bg-white/80 z-10" />

      {/* Konten */}
      <div className="relative z-20 pt-20 pb-10 text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
            {teamMembers.slice(0, 4).map((member, index) => {
              ...
              return (
                ...
                >
                  <motion.div
                    className="w-36 h-36 sm:w-44 sm:h-44 flex justify-center items-center"
