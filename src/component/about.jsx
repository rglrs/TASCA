...
const About = () => {
  ...
  const features = [
    {
      ...
      description: "Organize your assignments, projects, and daily to-dos with our intuitive task management system.",
      icon: (
    ...
    },
    {
      ...
      description: "Enhance focus and productivity with built-in Pomodoro timer for structured work sessions and breaks.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-[#28A745]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: "Study Planner",
      description: "Plan your study sessions, track progress, and visualize your academic journey effectively.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-[#FD7E14]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <section id="about" ref={ref} className="bg-indigo-200 py-20 md:py-32 px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            TASCA adalah aplikasi manajemen tugas dan belajar yang dirancang untuk membantu
            Anda mengelola waktu dan meningkatkan produktivitas dengan metode 
          ...
          >
            <div className="relative">
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="bg-[#F7F1FE] p-4 rounded-lg">
                    ...
                    <div className="text-sm text-gray-500 mt-1">Due in 5 days</div>
                  </div>
                  ...
                  <div className="bg-[#F7F1FE] p-4 rounded-lg">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div className="bg-[#FD7E14] h-2.5 rounded-full" style={{ width: '45%' }}></div>
                    </div>
                    <div className="text-sm text-gray-500 mt-1">4 pomodoros today</div>
                  </div>
                  ...
                  <div className="bg-[#F7F1FE] p-4 rounded-lg">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div className="bg-[#007BFF] h-2.5 rounded-full" style={{ width: '90%' }}></div>
                    </div>
                    <div className="text-sm text-gray-500 mt-1">Almost complete!</div>
                  </div>
                </div>
              ...
              <div className="absolute -bottom-4 -right-4 grid grid-cols-3 gap-2">
                {[...Array(9)].map((_, i) => (
                  <div key={i} className="w-2 h-2 bg-[#007BFF]/40 rounded-full"></div>
                ))}
              </div>
            </div>
          </motion.div>
        ...
        >
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            TASCA cocok untuk mahasiswa, pelajar, dan profesional yang ingin mengatur waktu dengan lebih baik 
            dan mencapai tujuan mereka secara lebih efisien dan terstruktur.
          </p>
        </motion.div>
      </div>
    </section>
