    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-gray-100 p-4">
      <AnimatePresence>
        ...
        >
          ...
          <Link to="/">
            <button className="bg-blue-600 text-white px-4 md:px-6 py-2 md:py-3 rounded-xl font-semibold hover:bg-blue-800 transition-transform duration-300 hover:scale-110">
              Kembali ke Beranda
            </button>
          </Link>
        </motion.div>
