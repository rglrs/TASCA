...
class _AddTaskPageState extends State<AddTaskPage> {
  ...
  final GlobalKey _deadlineDateKey = GlobalKey();
  final GlobalKey _deadlineTimeKey = GlobalKey();

  late AddTaskCoachMark _coachMark;
  ...
  void initState() {
    ...
    _coachMark = AddTaskCoachMark(
      context: context,
      titleKey: _titleKey,
      notesKey: _notesKey,
      priorityKey: _priorityKey,
      deadlineDateKey: _deadlineDateKey,
      deadlineTimeKey: _deadlineTimeKey,
    );
