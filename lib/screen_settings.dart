...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: SettingsScreen(isDarkMode: isDarkMode, onThemeToggle: toggleTheme),
    );
  }
}
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final subtitleColor = widget.isDarkMode ? Colors.grey.shade400 : Colors.grey;
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text('aloxander@gmail.com',
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ListTile(
                            leading: Icon(
                              widget.isDarkMode ? Icons.dark_mode : Icons.wb_sunny_outlined,
                              color: iconColor,
                            ),
                            title: Text('Shift Mode',
                              style: TextStyle(
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ListTile(
                            leading: Icon(Icons.g_mobiledata, size: 28, color: iconColor),
                            title: Text('Linking With Google',
                              style: TextStyle(
                                fontWeight: FontWeight.w500,
                                color: textColor,
                              ),
                          ...
                          ListTile(
                            leading: Icon(Icons.g_mobiledata, size: 28, color: iconColor),
                            title: Text('Unlinking With Google',
                              style: TextStyle(
                                fontWeight: FontWeight.w500,
                                color: textColor,
                              ),
